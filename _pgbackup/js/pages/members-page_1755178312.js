...
<head>
  ...
  <style>
    ...
    .chips .chip:hover{background:#f9fafb}
...
<main class="container-fluid py-4" data-pg-slot="main-content">
    ...
    <div class="d-flex align-items-center gap-2">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li><a class="dropdown-item" href="#" id="btnImport">Import CSV</a></li>
          <li><a class="dropdown-item" href="#" id="btnExport">Export CSV</a></li>
        </ul>
      </div>
  ...
  <div class="card card-table shadow-sm">
          ...
          <tr id="loadingRow">
            <td colspan="8">
              <div class="spinner-wrap d-flex align-items-center justify-content-center py-5">
                ...
                <span class="ms-2 muted">Loading…</span>
              </div>
            </td>
          </tr>
        </tbody>
    ...
    <!-- Footer -->
    <div class="d-flex align-items-center justify-content-between p-3 table-foot">
      <small class="muted" id="showingText">Showing 0</small>
